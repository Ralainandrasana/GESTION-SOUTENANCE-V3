...
create table Soutenir(MATRICULE varchar(10) PRIMARY KEY,IDORG varchar(5),ANNEE_UNIV varchar(10), NOTE int,PRESIDENT varchar(5),EXAMINATEUR varchar(5),RAPPORTEUR_INT varchar(5),RAPPORTEUR_EXT varchar(5));
