...
?>
            <tr <?php if($i%2){echo 'class="impaire"';  }?> >
                ...
                <td><a href="../page_edit/edit_etudiant.php?matricule=<?php echo $matricule[$i]; ?>" id="corb"><i class="fas fa-edit" style="color:var(--green_color);"></i></a></td>
                <td><a href="../fonction_delete/fct_delete_etudiant.php?matricule=<?php echo $matricule[$i]; ?>"><i class="fas fa-trash-alt" style="color:var(--red_color);" ></i></a></td>
            </tr>
<?php
        }
?>
